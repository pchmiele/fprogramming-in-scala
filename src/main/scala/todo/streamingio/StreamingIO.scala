package todo.streamingio

import todo.iomonad.{IO,Monad,Free,unsafePerformIO}
...
object GeneralizedStreamTransducers {
  ...
  object Process {
    ...
    import todo.iomonad.IO0.fahrenheitToCelsius
