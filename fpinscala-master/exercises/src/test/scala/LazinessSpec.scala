...
class StreamsSpec extends FlatSpec with Matchers {
  ...
  "zipAll" should "return List((Some(1),Some(4)), (Some(2),Some(5)), (Some(3),Some(6))) for given List(1,2,3) and List(4,5,6)" in {
    Stream(1,2,3).zipAll(Stream(4,5,6)).toList should be (List((Some(1),Some(4)), (Some(2),Some(5)), (Some(3),Some(6))))
  }

  it should "return List((Some(1),Some(4)), (Some(2),Some(5)), (Some(3), None)) for given List(1,2,3) and List(4,5)" in {
    Stream(1,2,3).zipAll(Stream(4,5)).toList should be (List((Some(1),Some(4)), (Some(2),Some(5)), (Some(3), None)))
  }

  it should "return List((Some(1),Some(4)), (Some(2),Some(5)), (None, Some(6)) for given List(1,2) and List(4,5,6)" in {
